...
export default function GoogleSignInButton({
  ...
  return (
    <Button
      ...
      variant="outline"
      className="w-full h-12 bg-neutral-800/60 hover:bg-neutral-700 border-neutral-700 text-gray-200 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all"
    >
      {isLoading ? (
        <>
